  ...
  const navLinks = [...document.querySelectorAll('nav.pill a, .mobile-tabbar a, .project-subnav a')];
  ...
  // screen (clamped to the viewport, snapping to the nearest side on
  // release), while a plain tap still toggles the theme. It always
  // starts back in its default top-right corner on a fresh page load —
  // dragged position is not remembered across visits.
